...
alias vni5='vni -5           -o /tmp/vnstati_5min.png         && echo "/tmp/vnstati_5min.png"        &&  peek /tmp/vnstati_5min.png'
alias vnid='vni -d           -o /tmp/vnstati_daily.png        && echo "/tmp/vnstati_daily.png"       &&  peek /tmp/vnstati_daily.png'
alias vnih='vni --hours      -o /tmp/vnstati_hours.png        && echo "/tmp/vnstati_hours.png"       &&  peek /tmp/vnstati_hours.png'
alias vnihg='vni --hoursgraph -o /tmp/vnstati_hoursgraph.png  && echo "/tmp/vnstati_hoursgraph.png"  &&  peek /tmp/vnstati_hoursgraph.png'

alias vnim='vni -m           -o /tmp/vnstati_monthly.png      && echo "/tmp/vnstati_monthly.png"     &&  peek /tmp/vnstati_monthly.png'
alias vniy='vni -y           -o /tmp/vnstati_yearly.png       && echo "/tmp/vnstati_yearly.png"      &&  peek /tmp/vnstati_yearly.png'
alias vnit='vni -t           -o /tmp/vnstati_top.png          && echo "/tmp/vnstati_top.png"         &&  peek /tmp/vnstati_top.png'
alias vnis='vni -s           -o /tmp/vnstati_summary.png      && echo "/tmp/vnstati_summary.png"     &&  peek /tmp/vnstati_summary.png'
alias vni5g='vni -5g         -o /tmp/vnstati_5mingraph.png    && echo "/tmp/vnstati_5mingraph.png"   &&  peek /tmp/vnstati_5mingraph.png'

# --- Summary layouts ---
alias vnihs='vni --hsummary  -o /tmp/vnstati_hsummary.png     && echo "/tmp/vnstati_hsummary.png"    &&  peek /tmp/vnstati_hsummary.png'
alias vnivs='vni --vsummary  -o /tmp/vnstati_vsummary.png     && echo "/tmp/vnstati_vsummary.png"    &&  peek /tmp/vnstati_vsummary.png'

# --- 95th percentile (useful for bandwidth billing) ---
alias vni95='vni --95th 0    -o /tmp/vnstati_95th.png         && echo "/tmp/vnstati_95th.png"        &&  peek /tmp/vnstati_95th.png'
