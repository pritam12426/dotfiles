...
export DOT_FILE="$HOME/Developer/git_repository/dotfiles/debian"
...
export NNN_SEL="/tmp/nnn.sel"                        # Define NNN selection file
# export NNN_OPENER="/usr/bin/open"                       # Set default opener for files
# export NNN_TRASH="/usr/bin/trash"                       # Define NNN trash command
export NNN_FIFO="/tmp/nnn.fifo"                      # Define NNN FIFO file
export NNN_TMPFILE="/tmp/nnn.lastd"                  # Define NNN temporary file for last directory
...
function ranger() {
	ID="$$"
	OUTPUT_FILE="/tmp/joshuto-cwd-$ID"
